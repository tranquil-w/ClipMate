...
namespace ClipMate.Tests.ViewModels
{
    ...
    public class ClipboardViewModelTests : TestBase
    {
        ...
        #region AppendSearchText Tests

        [Fact]
        public async Task AppendSearchText_ShouldAppendToSearchQuery()
        {
            await TestHost.SwitchToAppThread();
            ...
            // Act
            viewModel.AppendSearchText("123");

            // Assert
            Assert.Equal("test123", viewModel.SearchQuery);
        }

        [Fact]
        public async Task AppendSearchText_Empty_ShouldDoNothing()
        {
            await TestHost.SwitchToAppThread();
            ...
            // Act
            viewModel.AppendSearchText(string.Empty);

            // Assert
            Assert.Equal("test", viewModel.SearchQuery);
        }

        [Fact]
        public async Task AppendSearchText_Null_ShouldDoNothing()
        {
            await TestHost.SwitchToAppThread();
            ...
            // Act
            viewModel.AppendSearchText(null!);
        ...
        [Fact]
        public async Task AppendSearchText_ShouldRaiseSearchBoxFocusRequested()
        {
            await TestHost.SwitchToAppThread();
            ...
            viewModel.SearchBoxFocusRequested += (_, _) => eventRaised = true;

            // Act
            viewModel.AppendSearchText("a");
        ...
        [Fact]
        public async Task AppendSearchText_FromEmpty_ShouldSetSearchQuery()
        {
            await TestHost.SwitchToAppThread();
            ...
            // Act
            viewModel.AppendSearchText("hello");

            // Assert
            Assert.Equal("hello", viewModel.SearchQuery);
        }
